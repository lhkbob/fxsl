 ...
 *
 * Type conversion represents the related task of finding a new type that two initial types are both
...
public interface Type {
     ...
     * values in `t` to values of `this`. Lastly, implementations should treat wildcard types as being
     ...
     * value is returned.
     *
     * This function is commutative, namely `this.getValidConversion(t)` should produce the same result as
     * `t.getValidConversion(this)`. Since conversions only cross class boundaries in a limited number of
