 ...
 *
 * 1. Primitives ({@link PrimitiveType}): `int`, `float`, `bool`, `sampler1d`, `sampler2d`, and `sampler3d`.
 ...
 * 5. Unions ({@link UnionType}): Collection of functions that supports limited ad-hoc polymorphism.
 ...
 * related notion of expression concreteness described by {@link com.lhkbob.fxsl.lang.expr.Expression}.
 *
 * ## Implementation note
 *
